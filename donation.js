document.addEventListener("DOMContentLoaded", () => {
  ...
  web3Script.src = "https://cdn.jsdelivr.net/npm/web3@1.7.3/dist/web3.min.js";
  web3Script.onload = initializeDonationForm;
  ...
  function initializeDonationForm() {
    ...
    // Check if Web3 has been injected by MetaMask (or another provider)
      ...
      window.ethereum
        ...
        .then(async (accounts) => {
          ...
          donationForm.addEventListener("submit", async (event) => {
            ...
            try {
              if (donationType === "ETH") {
                const donationValue = web3.utils.toWei(
                  amount.toString(),
                  "ether"
                );
          ...
          const donationContainer = document.querySelector(
            ".donation-container"
          );
